...
public class SelectUserAdapter extends RecyclerView.Adapter<SelectUserAdapter.viewHolder>{
    ...
    public SelectUserAdapter(Context context, List<Users> list, SelectUserView view) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SelectUserAdapter.viewHolder(LayoutInflater.from(context).inflate(R.layout.select_users_list_layout, parent, false));
    }
    ...
    class viewHolder extends RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            circleImageView = itemView.findViewById(R.id.select_users_list_layout_image_profile);
            textUser = itemView.findViewById(R.id.select_users_list_layout_username);
            box = itemView.findViewById(R.id.select_users_list_layout_check_box);
            cardView = itemView.findViewById(R.id.users_list_select_layout_card);
        }
